...
#define STEPPER_BANK				GPIOD//GPIOB	
...
#define STEPPER_HORIZONTAL_STEP_BANK          GPIOD//GPIOB

#define STEPPER_VERTICAL_DIR_BANK             GPIOC
#define STEPPER_VERTICAL_ENABLE_BANK          GPIOC
#define STEPPER_VERTICAL_STEP_BANK            GPIOD//GPIOB
...
void initialize_stepper_objects();
