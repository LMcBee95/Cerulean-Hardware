...
/*
 *	This code initializes I2C1 on pin PB6 as SCL and pin PB7 as SDA. The sketch then uses the functions defined 
 *	in this sketch to wrtie to an I2C slave and then recieve a message back. The address of the slave is  a constant
 *	at the top of the code.s
 */
...
#define SLAVE_ADDRESS 2 // the slave address (example)
