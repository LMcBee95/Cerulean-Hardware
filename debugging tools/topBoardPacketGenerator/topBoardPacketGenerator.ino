//To use this sketch, connect pin 2 and 3 as the RX and TX pins. Pin 4 is the READ/WRITE pin
//Open up the serial monitor and specify a packet to send in
//The following manner:

// MOTOR1 MOTOR2 MOTOR3 MOTOR4 MOTOR5 MOTOR5 MOTOR7 MOTOR8 TOOL1 TOOL2 R G B <CHECKSUM>!
...
//Less than 13 arguments will result in random garbage being sent probably
//More than 13 will result in a corrupt checksum
...
void getResponse()
{
  ...
  digitalWrite(READ_WRITE,LOW);        //Now reading input from slave
  ...
  digitalWrite(READ_WRITE,HIGH);     //Done reading input from slave
