...
#define SERVO_1_TIMER_CLOCK			RCC_APB1Periph_TIM3
#define SERVO_1_TIMER_PIN_AF		GPIO_AF_TIM3
#define SERVO_1_TIMER				TIM3
#define SERVO_1_CLOCK_BANK			RCC_AHB1Periph_GPIOA
#define SERVO_1_BANK   				GPIOA
#define SERVO_1_PIN					GPIO_Pin_6
#define SERVO_1_PIN_SOURCE			GPIO_PinSource6
#define SERVO_1_CCR					TIM3->CCR1

/*** Setting Servo Angle ***/

#define SERVO_PERIOD				26250
#define MAXSERVO 					2.1
#define MINSERVO 					0.8
